...
CopyTransform::CopyTransform(glm::uvec3 wTile, glm::uvec3 iTile)
...
bool CopyTransform::supports(const OpCopy &op) const {
...
CopyShaderSource CopyTransform::do_specialize(const OpCopy &op) const {
...
std::string_view CopyTransform::name() const { return m_name; }

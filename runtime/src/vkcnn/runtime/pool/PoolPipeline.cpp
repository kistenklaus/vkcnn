...
PoolPipeline::PoolPipeline(const ::merian::ContextHandle &context,
...
void PoolPipeline::run(const ::merian::CommandBufferHandle &cmd,
  ...
  glm::uvec3 workgroupCount = (glm::uvec3(output.c(), output.w(), output.h()) +
